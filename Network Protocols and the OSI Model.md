...
| Kerberos             |                                            | Application, Presentation, Session, Transport, Network                      | #authentication #security #tickets #kdc #session-keys #application #presentation #session #transport #network #protocol                                                      |
